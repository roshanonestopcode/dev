        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12 view-profile-search">
                <?php if (!empty($clientprofile[0]->profile_image)) { ?>
                    <img style="margin-top:18px;" id="target" alt="" class="img-rounded img-responsive" src="<?php echo $clientprofile[0]->profile_image; ?>"/>
                <?php } else { ?>
                    <img style="margin-top:18px;" id="target"  class="img-rounded img-responsive" src="<?php echo base_url(); ?>assets/images/default_user.png">
                <?php } ?>
                <br />
                <br />
                ...
                <h4><strong>Category:</strong> 
                    ...
                    ?>
                    <h2 ><a class="btn btn-invite-search-user" href="<?php echo base_url(); ?>sign_in_client/<?php echo $consult_id; ?>"> Invite </a></h2>  	
            </div>
            <!----End User Profile---->
            <!----User Profile Detail---->
            <div class="col-md-9 col-sm-9 col-xs-12">
                <div class="view-profile-search-desc" style="">
                    <h2 style="font-size:24px;" >Lawyer Description</h2>
                    <hr>
