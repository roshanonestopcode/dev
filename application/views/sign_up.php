...
<div class="container" >
    <div class="jumbotron jumbotron-sm-box" >
        <h2 class="or-divider-h2">you're looking For.</h2>
        <div class="row "  style="min-height: 189px;">
            ...
            if (empty($user['userId'])) {
                ...
                ?>
                <div class="col-md-5 col-xs-12 col-sm-6 con1-col">
                    <center style="margin-top:5%;">
                        ...
                        <a href="<?php echo base_url(); ?>user_register/<?php echo $lawyer_id; ?>" class="lawyer-buttons">Lawyer</a>
                    </center>
                </div>
                ...
                <div class="col-md-5 col-xs-12 col-sm-6 con1-col">
                    <center style="margin-top:5%;">
                        ...
                        <a href="<?php echo base_url(); ?>user_register/<?php echo $consult_id; ?>" class="lawyer-buttons">Client</a>
                    </center>
                </div>         
            <?php } ?>
        </div>
