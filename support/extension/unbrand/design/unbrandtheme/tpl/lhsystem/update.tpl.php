...
<div class="row">
	<div class="col-md-4">
		...
		<a class="btn btn-default btn-xs" href="http://elochat.com/support/index.php/site_admin/" target="_blank"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/update','News')?></a>
		<a class="btn btn-default btn-xs" href="http://elochat.com/support/index.php/site_admin/" target="_blank"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/update','Update instructions')?></a>
